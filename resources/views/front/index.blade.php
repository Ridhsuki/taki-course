...
<body class="text-black font-poppins pt-10 pb-[50px]">
    <div id="hero-section" class="max-w-[1200px] mx-auto w-full flex flex-col gap-10 pb-[50px] bg-[url('assets/background/Hero-Banner.png')] bg-center bg-no-repeat bg-cover rounded-[32px] overflow-hidden">
        <nav class="flex justify-between items-center pt-6 px-[50px]">
            ...
            <div class="flex gap-[10px] items-center">
                <a href="{{ route('login') }}" class="text-white font-semibold rounded-[30px] p-[16px_32px] ring-1 ring-white transition-all duration-300 hover:ring-2 hover:ring-[#FF6129]">Sign Up</a>
        ...
        <div class="flex flex-col items-center gap-[30px]">
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <p class="text-center text-xl leading-[36px] text-[#F5F8FA]">Taki Course provides high quality online courses for you to grow <br>
                ...
                <div class="testi-container animate-[slideToL_50s_linear_infinite] group-hover/slider:pause-animate flex gap-6 pl-6 items-center flex-nowrap">
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        <div class="flex items-center gap-3">
                            ...
                            <p class="font-semibold">Rina Aulia</p>
                        </div>
                        <p class="text-sm text-[#475466]">Taki Course completely changed the way I learn, the materials are thorough and easy to follow!</p>
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">Thanks to Taki Course, I successfully switched careers from admin to front-end developer in just 6 months!</p>
                        <div class="flex gap-[2px]">
                            <div>
                                <img src="assets/icon/star.svg" alt="star">
                            </div>
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">The quality of mentors and course content at Taki Course far exceeded my expectations. Highly recommended!</p>
                        <div class="flex gap-[2px]">
                            <div>
                                <img src="assets/icon/star.svg" alt="star">
                            </div>
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 flex shrink-0 rounded-full overflow-hidden">
                                <img src="assets/photo/photo2.png" class="w-full h-full object-cover" alt="photo">
                            </div>
                            <p class="font-semibold">Arif Hidayat</p>
                        </div>
                        <p class="text-sm text-[#475466]">Taki Course has helped me to grow from zero to a perfect career, thank you so much!</p>
                        <div class="flex gap-[2px]">
                            <div>
                                <img src="assets/icon/star.svg" alt="star">
                            </div>
            ...
            <div class="group/slider flex flex-nowrap w-max items-center">
                <div class="logo-container animate-[slideToR_50s_linear_infinite] group-hover/slider:pause-animate flex gap-6 pl-6 items-center flex-nowrap">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <p class="font-semibold">Mega Putri</p>
                    </div>
                    <p class="text-sm text-[#475466]">The project-based learning approach at Taki Course lets me practice hands-on, not just theory!</p>
                    <div class="flex gap-[2px]">
                        <div>
                            <img src="assets/icon/star.svg" alt="star">
                        </div>
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        <div class="flex items-center gap-3">
                            <div class="w-8 h-8 flex shrink-0 rounded-full overflow-hidden">
                                <img src="assets/photo/photo3.png" class="w-full h-full object-cover" alt="photo">
                            </div>
                            <p class="font-semibold">Bagus Setiawan</p>
                        </div>
                        <p class="text-sm text-[#475466]">After completing the bootcamp at Taki Course, I landed a job at my dream tech company right away!</p>
                        <div class="flex gap-[2px]">
                            <div>
                                <img src="assets/icon/star.svg" alt="star">
                            </div>
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">I love how the lessons are delivered step by step, clear and never confusing. Best learning platform!</p>
                        <div class="flex gap-[2px]">
                            <div>
                                <img src="assets/icon/star.svg" alt="star">
                            </div>
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">Taki Course gave me a strong foundation to build my career in web development. Absolutely worth it!</p>
                        <div class="flex gap-[2px]">
                            <div>
                                <img src="assets/icon/star.svg" alt="star">
                            </div>
    ...
    <footer class="max-w-[1200px] mx-auto flex flex-col pt-[70px] pb-[50px] px-[100px] gap-[50px] bg-[#F5F8FA] rounded-[32px]">
        ...
        <div class="w-full h-[51px] flex items-end border-t border-[#E7EEF2]">
            <p class="mx-auto text-sm text-[#6D7786] -tracking-[2%]">All Rights Reserved Taki Course BuildWithAngga 2024</p>
        </div>
    </footer>
