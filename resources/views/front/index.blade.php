    ...
    <div id="hero-section"
        ...
        <div class="flex flex-col items-center gap-[30px]">
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <p class="text-center text-xl leading-[36px] text-[#F5F8FA]">Taki Course provides high quality online
                                ...
                                <div class="flex items-center gap-2">
                                    <div class="w-8 h-8 flex shrink-0 rounded-full overflow-hidden">
                                        <img src="{{ $course->teacher->user->avatar ? Storage::url($course->teacher->user->avatar) : asset('images/default-avatar.png') }}"
                                            class="w-full h-full object-cover" alt="icon" loading="lazy">
                                    </div>
                                    <div class="flex flex-col">
            ...
            <div class="group/slider flex flex-nowrap w-max items-center">
                <div
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">Taki Course completely changed the way I learn, the materials
                            are thorough and easy to follow!</p>
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">Thanks to Taki Course, I successfully switched careers from
                            admin to front-end developer in just 6 months!</p>
                        <div class="flex gap-[2px]">
                            <div>
                                <img src="assets/icon/star.svg" alt="star">
                            </div>
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">The quality of mentors and course content at Taki Course far
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">Taki Course has helped me to grow from zero to a perfect
            ...
            <div class="group/slider flex flex-nowrap w-max items-center">
                <div
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">The project-based learning approach at Taki Course lets me
                            practice hands-on, not just theory!</p>
                        <div class="flex gap-[2px]">
                            <div>
                                <img src="assets/icon/star.svg" alt="star">
                            </div>
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">After completing the bootcamp at Taki Course, I landed a job
                            at my dream tech company right away!</p>
                        <div class="flex gap-[2px]">
                            <div>
                                <img src="assets/icon/star.svg" alt="star">
                            </div>
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">I love how the lessons are delivered step by step, clear and
                            never confusing. Best learning platform!</p>
                        <div class="flex gap-[2px]">
                            <div>
                                <img src="assets/icon/star.svg" alt="star">
                            </div>
                    ...
                    <div class="test-card w-[300px] flex flex-col h-full bg-white rounded-xl gap-3 p-5">
                        ...
                        <p class="text-sm text-[#475466]">Taki Course gave me a strong foundation to build my career in
                            web development. Absolutely worth it!</p>
                        <div class="flex gap-[2px]">
                            <div>
                                <img src="assets/icon/star.svg" alt="star">
                            </div>
